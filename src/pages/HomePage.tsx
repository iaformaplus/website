...
const HomePage: React.FC = () => {
  ...
  const openCallbackModal = () => {
    // Supprimer la clé localStorage pour forcer l'affichage du modal
    localStorage.removeItem('callbackModalShown');
    // Recharger la page pour déclencher le modal
  ...
  return (
    <>
      ...
      {/* Nouveau bandeau - Types de formations */}
      ...
      {/* IA Benefits Section avec vidéo restaurée */}
      <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white overflow-hidden">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Vidéo restaurée - Animation IA interactive */}
      ...
      {/* CTA Section avec LOGO IA FORMA PLUS restauré */}
        ...
        <div className="container">
          <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[400px]">
              ...
              {/* LOGO IA FORMA PLUS avec animation - RESTAURÉ */}
