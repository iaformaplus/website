        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/formations-securite" className="text-gray-400 hover:text-primary transition-colors">
                  Formations Sécurité
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/blog/actualite-ia" className="text-gray-400 hover:text-primary transition-colors">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="text-gray-400 text-sm max-w-md">
                ...
                <p className="text-xs mt-1">Catégorie : Actions de formation</p>
              </div>
            </div>
